...
@Autonomous
public class oldBC extends LinearOpMode {
            ...
            if (tfod != null) {
                ...
                if (updatedRecognitions != null) {
                    ...
                    if (updatedRecognitions.isEmpty() != true) {
                        ...
                        telemetry.update();
                        if (updatedRecognitions.get(0).getLeft() > 220){ //right
                            while (time < 3) {
                                block.leftturn(0.025 * (getAngle() - 35));
                            }
                            block.stop();
                            block.backward(0.3);
                            ...
                            sleep(500);
                            while (time < 15) {
                                block.leftturn(0.02 * (getAngle() - 180));
                            }
                            resetAngle();
                            sleep(500);
                            while (time < 20) {
                                double power = 0.2;
                                double differenceStraight = (back.getDistance(DistanceUnit.INCH) - 6.6);
                                double straight = differenceStraight*0.3;
                                double differenceSide = (right.getDistance(DistanceUnit.INCH) - 1);
