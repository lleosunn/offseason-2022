                ...
                if (updatedRecognitions != null) {
                    ...
                    if (updatedRecognitions.isEmpty() != true) {
                        ...
                        if (updatedRecognitions.get(0).getLeft() < 220) { //left
                            ...
                            block.setDrivetrainTarget(925, -925, 925, -925);
                            ...
                            block.setDrivetrainMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                            block.setDrivetrainMode(DcMotor.RunMode.RUN_USING_ENCODER);
                            block.setDrivetrainTarget(-225, 225, -225, 225);
                            block.setDrivetrainMode(DcMotor.RunMode.RUN_TO_POSITION);
                            ...
                            block.setDrivetrainMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                            block.setDrivetrainMode(DcMotor.RunMode.RUN_USING_ENCODER);
                            block.setDrivetrainTarget(-2200, 600, -600, 2200);
                            block.setDrivetrainMode(DcMotor.RunMode.RUN_TO_POSITION);
                            block.setDrivetrainPower(0.4, 0.4, 0.4, 0.4);
                            sleep(4000);
                            while (time < 18) {
                                intake.setPower(0.4);
                            }
                            ...
                            block.setDrivetrainMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                            block.setDrivetrainMode(DcMotor.RunMode.RUN_USING_ENCODER);
                            block.setDrivetrainTarget(1100, 1500, -1500, -1100);
                            block.setDrivetrainMode(DcMotor.RunMode.RUN_TO_POSITION);
                            block.setDrivetrainPower(0.3, 0.3, 0.5, 0.5);
                            sleep(5000);
                            stop();
                        } else { //middle
                            while (time < 2) {
