                ...
                if (updatedRecognitions != null) {
                    ...
                    if (updatedRecognitions.isEmpty() != true) {
                        ...
                        if (updatedRecognitions.get(0).getLeft() < 220) { //left
                            ...
                            block.setDrivetrainTarget(1025, -1025, 1025, -1025);
                            ...
                            block.setDrivetrainMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                            block.setDrivetrainMode(DcMotor.RunMode.RUN_USING_ENCODER);
                            block.setDrivetrainTarget(-325, 325, -325, 325);
                            block.setDrivetrainMode(DcMotor.RunMode.RUN_TO_POSITION);
                            ...
                            while (time < 9) {
                                block.leftturn(0.015 * (getAngle() + 90));
                            }
                            resetAngle();

                            //strafe right to wall 13 seconds
                            while (time < 12) {
                                block.leftDistance(0.2, (left.getDistance(DistanceUnit.INCH) - 2),
                                        (left.getDistance(DistanceUnit.INCH) - 2) * 0.4, getAngle());
                        ...
                        while (time < 2) {
                            block.leftturn(0.015 * (getAngle() + 40));
                        }
                        block.stop();

                        block.setDrivetrainMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                        block.setDrivetrainMode(DcMotor.RunMode.RUN_USING_ENCODER);
                        block.setDrivetrainTarget(1200, -1200, 1200, -1200);
                        block.setDrivetrainMode(DcMotor.RunMode.RUN_TO_POSITION);
                        block.setDrivetrainPower(0.5, 0.5, 0.5, 0.5);
                        lift.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                        lift2.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                        ...
                        block.setDrivetrainMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                        block.setDrivetrainMode(DcMotor.RunMode.RUN_USING_ENCODER);
                        block.setDrivetrainTarget(-500, 500, -500, 500);
                        block.setDrivetrainMode(DcMotor.RunMode.RUN_TO_POSITION);
                        block.setDrivetrainPower(0.3, 0.3, 0.3, 0.3);
                        sleep(2000);
                        block.stop();
